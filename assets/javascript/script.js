...
// forloop to display data from localstorage
...
// Key count will log searches
var keyCount = 0;
// Search button turns to click event 
searchButton.click(function () {

    var searchInput = $(".searchInput").val();

    // Variable with Endpoint for current weather 
    var urlCurrent = "https://api.openweathermap.org/data/2.5/weather?q=" + searchInput + "&Appid=" + apiKey + "&units=imperial";
    // Variable with Endpoint for 5 day forecast
    ...
    if (searchInput == "") {
        ...
        $.ajax({
            ...
            // Append displays Current Weather append 
            ...
            // Adds info to CurrentCard
            var currentTemp = currentName.append("<p>");
            // Append adds (TEMP, Humidity, Wind Speed);
            currentName.append(currentTemp);
            currentTemp.append("<p>" + "Temperature: " + response.main.temp + "</p>");
            currentTemp.append("<p>" + "Humidity: " + response.main.humidity + "%" + "</p>");
            currentTemp.append("<p>" + "Wind Speed: " + response.wind.speed + "</p>");

            // API endpoint for UV Index 
